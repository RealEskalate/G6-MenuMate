...
import 'package:dinq/core/error/failure.dart';
...
class _QrScannerPageState extends State<QrScannerPage> {
  ...
  Future<void> _processImage(File imageFile) async {
    try {
      ...
      if (branchId == null) {
        _showFailure(NotFoundFailure('Branch ID not found in QR code.'));
        return;
      }
      ...
      if (result is ServerFailure) {
        ...
        _showFailure(NotFoundFailure('No menu published for this branch.'));
      }
    } catch (e) {
  ...
  Future<dynamic> checkMenuExists(String branchId) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return NotFoundFailure('No menu published for this branch.');
      } else {
