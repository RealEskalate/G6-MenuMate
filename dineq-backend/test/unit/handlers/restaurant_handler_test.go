...
func (m *mockRestaurantUsecase) CreateRestaurant(context.Context, *domain.Restaurant) error { return nil }
func (m *mockRestaurantUsecase) UpdateRestaurant(context.Context, *domain.Restaurant) error { return nil }
...
func (m *mockRestaurantUsecase) GetRestaurantBySlug(_ context.Context, slug string) (*domain.Restaurant, error) {
    if m.deletedSlugs == nil { m.deletedSlugs = map[string]bool{} }
    if m.deletedSlugs[slug] { return nil, domain.ErrRestaurantDeleted }
    r := m.bySlug[slug]
    if r == nil { return nil, domain.ErrRestaurantNotFound }
    return r, nil
}
...
func (m *mockRestaurantUsecase) ListBranchesBySlug(context.Context, string, int, int) ([]*domain.Restaurant, int64, error) { return nil, 0, nil }
func (m *mockRestaurantUsecase) ListUniqueRestaurants(context.Context, int, int) ([]*domain.Restaurant, int64, error) { return nil, 0, nil }
