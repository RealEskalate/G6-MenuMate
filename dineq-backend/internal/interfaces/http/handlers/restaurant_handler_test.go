...
func (m *mockRestaurantUsecase) CreateRestaurant(_ context.Context, _ *domain.Restaurant) error {
	return nil
}
func (m *mockRestaurantUsecase) UpdateRestaurant(_ context.Context, _ *domain.Restaurant) error {
	return nil
}
func (m *mockRestaurantUsecase) DeleteRestaurant(_ context.Context, _ string, _ string) error {
	return nil
}
...
func (m *mockRestaurantUsecase) ListBranchesBySlug(_ context.Context, _ string, _ int, _ int) ([]*domain.Restaurant, int64, error) {
	return nil, 0, nil
}
func (m *mockRestaurantUsecase) ListUniqueRestaurants(_ context.Context, _ int, _ int) ([]*domain.Restaurant, int64, error) {
	return nil, 0, nil
}
