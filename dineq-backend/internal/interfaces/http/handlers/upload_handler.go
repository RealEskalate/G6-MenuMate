...
func NewImageUploadHandler(storage services.StorageService) *ImageUploadHandler {
	return &ImageUploadHandler{Storage: storage}
}
...
func (h *ImageUploadHandler) UploadLogo(c *gin.Context) {
	c.Request.Form.Add("folder", "qr-assets")
	h.UploadImage(c)
}
