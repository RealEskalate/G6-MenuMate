...
class SaveFavoriteRestaurantIdsEvent extends UserEvent {
  final String id;

  const SaveFavoriteRestaurantIdsEvent({required this.id});

  @override
  List<Object?> get props => [id];
}

class GetFavoriteRestaurantsEvent extends UserEvent {}

class ClearFavoritesEvent extends UserEvent {}
