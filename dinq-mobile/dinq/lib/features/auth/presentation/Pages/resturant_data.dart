        ...
        child: Center(
          child: Column(
            children: [
              ...
              CustomTextField(
                  labelText: 'Restaurant Name', initialText: widget.name),
              const SizedBox(height: 20), // Reduced from 40
              CustomTextField(
                  labelText: 'Phone Number', initialText: widget.phoneNumber),
              const SizedBox(height: 24),
              ...
              if (_selectedFile != null) _buildFileItem(_selectedFile!),
