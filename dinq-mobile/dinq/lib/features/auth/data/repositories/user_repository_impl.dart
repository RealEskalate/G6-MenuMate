...
class UserRepositoryImpl implements UserRepository {
          ...
          try {
            ...
            if (userJson != null &&
              ...
              if (favs != null) {
                ...
                for (final id in ids) {
                  await userLocalDataSource!.saveFavoriteRestaurantIds(id);
                }
              }
            }
          } catch (_) {}
  ...
  @override
  Future<Either<Failure, Unit>> cacheUserJson(User user) async {
    try {
      if (userLocalDataSource != null) {
        await userLocalDataSource!.cacheUserJson(UserModel.fromEntity(user).toJson());
        return const Right(unit);
      }
  ...
  @override
  Future<Either<Failure, Unit>> saveFavoriteRestaurantIds(String id) async {
    try {
      if (userLocalDataSource != null) {
        await userLocalDataSource!.saveFavoriteRestaurantIds(id);
        return const Right(unit);
  ...
  @override
  Future<Either<Failure, List<String>>> getFavoriteRestaurants() async {
    try {
      if (userLocalDataSource != null) {
        final ids = await userLocalDataSource!.getFavoriteRestaurants();
        return Right(ids);
      }
      return const Left(CacheFailure('Local data source not available'));
    } catch (e) {
  ...
  Future<Either<Failure, Unit>> clearFavorites() async {
    try {
      if (userLocalDataSource != null) {
        await userLocalDataSource!.clearFavorites();
        return const Right(unit);
      }
      return const Left(CacheFailure('Local data source not available'));
    } catch (e) {
  ...
  @override
  Future<Either<Failure, Unit>> deleteFavoriteRestaurantId(String id) async {
    try {
      if (userLocalDataSource != null) {
        await userLocalDataSource!.deleteFavoriteRestaurantId(id);
        return const Right(unit);
      }
      return const Left(CacheFailure('Local data source not available'));
    } catch (e) {
