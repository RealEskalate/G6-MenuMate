...
abstract class RestaurantRepository {
  // Restaurant
  Future<Either<Failure,Restaurant>> createRestaurant(RestaurantModel restaurant);
  Future<Either<Failure,List<Restaurant>>> getRestaurants(int page, int pageSize);
  Future<Either<Failure,Restaurant>> getRestaurantBySlug(String slug);
  Future<Either<Failure,Restaurant>> updateRestaurant(RestaurantModel restaurant, String slug);
  ...
  Future<Either<Failure, List<Category>>> getCategories(String tabId); // TODO: Delete
  // 
