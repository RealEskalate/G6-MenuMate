...
class _ItemDetailsPageState extends State<ItemDetailsPage> {
  ...
  void initState() {
    super.initState();
    // Load reviews and user images for this item
    context.read<RestaurantBloc>().add(LoadReviews(widget.item.id));
    context.read<RestaurantBloc>().add(LoadUserImages(widget.item.id));
  }
                ...
                children: [
                  ...
                  BlocBuilder<RestaurantBloc, RestaurantState>(
                    builder: (context, state) {
                      ...
                      // Fallback to static samples if not loaded
                      return Column(
                        children: [
                          _buildReviewTile(
                            name: 'Sarah M.',
                            ...
                            rating: 5,
                            review:
                                "Absolutely amazing! The flavors are authentic and the spice level is perfect.",
                            images: [
