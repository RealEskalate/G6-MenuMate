...
import '../../domain/entities/menu.dart' as menu_models;
import '../../domain/entities/tab.dart' as tab_models;
import '../../domain/entities/item.dart' as item_models;
import '../../domain/entities/restaurant.dart' as rest_models;
...
// For UI only
  ...
  List<item_models.Item> get allDishes {
    if (_menu == null) return [];
    return _menu!.tabs
        .expand((tab) => tab.categories)
        .expand((cat) => cat.items)
        .toList()
        .cast<item_models.Item>();
  }
        ...
        child: BlocBuilder<RestaurantBloc, RestaurantState>(
          builder: (context, state) {
            ...
            if (state is MenuLoaded) {
              // ensure tab controller is created with correct length
  ...
  Widget _buildTabContent(tab_models.Tab menuTab) {
  ...
  Widget _buildMenuItem(item_models.Item item) {
