...
class _LoginPageState extends State<LoginPage>
  ...
  // BLoC instance
  // UserBloc is provided via dependency injection (see `injection_container.dart`)

  @override
  void initState() {
    super.initState();

    // No local bloc creation: will use DI-provided instance in the widget tree
  ...
  // Note: UserBloc is provided by the app's service locator (sl) and
  // injected into this page via BlocProvider.value below.
                ...
                children: [
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      return Transform.translate(
                        offset:
                            Offset((1 - _emailFieldAnimation.value) * 50, 0),
                        child: Opacity(
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      return Transform.translate(
                        offset:
                            Offset(0, (1 - _googleButtonAnimation.value) * 20),
                        child: Opacity(
