            ...
            models.Category(
              ...
              items: [
                models.Item(
                  ...
                  description: 'Crispy pastry filled with spiced lentils and vegetables',
                  price: 45.0,
                  currency: 'ETB',
                ...
                models.Item(
                  ...
                  ingredients: ['Tomatoes', 'Onions', 'Jalapeños', 'Lemon juice'],
                  createdAt: DateTime.now(),
                  updatedAt: DateTime.now(),
                ),
              ],
            ...
            models.Category(
              ...
              items: [
                models.Item(
                  ...
                  ingredients: ['Chickpea flour', 'Onions', 'Garlic', 'Berbere spice'],
                  createdAt: DateTime.now(),
                  updatedAt: DateTime.now(),
                ),
                models.Item(
                  ...
                  ingredients: ['Red lentils', 'Onions', 'Garlic', 'Berbere spice'],
                  createdAt: DateTime.now(),
                  updatedAt: DateTime.now(),
                ),
              ],
            ...
            models.Category(
              ...
              items: [
                models.Item(
                  ...
                  ingredients: ['Chicken', 'Onions', 'Garlic', 'Berbere spice', 'Eggs'],
                  createdAt: DateTime.now(),
                  updatedAt: DateTime.now(),
                ),
                models.Item(
