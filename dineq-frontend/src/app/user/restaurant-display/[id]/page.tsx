...
import { fetchRestaurantById } from "@/store/restaurantsSlice";
      ...
      {!id ? (
        ...
        <div className="flex flex-col items-center px-4 sm:px-6 md:px-8 pb-8">
          ...
          <div className="w-full max-w-5xl h-40 sm:h-52 md:h-64 relative rounded-lg overflow-hidden shadow-lg mt-4">
            <SafeImage
              src={(currentRestaurant as any).logo_image ?? "/Background.png"}
          ...
          <div className="w-full max-w-5xl bg-gray-100 p-5 rounded-lg mt-5 shadow-md">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
              <div className="flex flex-col mb-4 md:mb-0">
                ...
                <p className="text-yellow-500 text-lg">⭐ {(currentRestaurant as any).average_rating ?? 0}</p>
                <p className="mt-2 text-gray-700">{currentRestaurant.about}</p>
              </div>
