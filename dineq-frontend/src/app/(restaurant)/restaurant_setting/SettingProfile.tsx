...
const SettingProfile = () => {
  return (
    <div className="w-13/14">
      <div className="border border-orange-200 rounded-2xl m-4 p-4">
        ...
        <div className="flex gap-10 mt-5 justify-between">
          <div>
            <label
              ...
              className="font-semibold text-1xl text-gray-700"
            >
              Restaurant name
            </label>
            <br />
            <input
              type="text"
              id="restaurant_name"
              className="border rounded-1xl p-2 mt-2 w-[24rem] "
            />
          </div>
          ...
          <div className="mr-64">
            ...
            <select
              id="country"
              className="font-semibold text-1xl text-gray-700 border rounded-1xl p-2 mt-2 w-[24rem]"
            >
        ...
        <div className="flex gap-10 mt-10 justify-between">
          <div>
            ...
            <label
              htmlFor="logo"
              className="flex flex-col items-center justify-center w-[24rem] max-w-md h-40 bg-white border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors"
            >
