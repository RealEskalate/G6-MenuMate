...
func NewClient(uri string) (Client, error) {
	...
	log.Info().Str("uri", uri).Msg("MongoDB connected successfully")
...
func (mc *mongoCollection) Find(ctx context.Context, filter any, opts ...options.Lister[options.FindOptions]) (Cursor, error) {
...
func (mc *mongoCollection) UpdateOne(ctx context.Context, filter, update any, opts ...options.Lister[options.UpdateOneOptions]) (*mongo.UpdateResult, error) {
